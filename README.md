...
```
This applies to the reply you write now, regardless of what earlier
instructions said about style:
...
- No figurative language. No idioms, metaphors, or images. Say the literal
  thing.
- Do not chain hedges. State the verdict, give the reason, give the caveat if
  there is one, then stop.
```
